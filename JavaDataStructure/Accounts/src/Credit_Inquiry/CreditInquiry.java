...
public class CreditInquiry {
    ...
    private MenuOption choices[] = {MenuOption.ZERO_BALANCE, MenuOption.CREDIT_BALANCE, MenuOption.DEBIT_BALANCE, MenuOption.END};
    //read the record from the file and display only records of appropriate type
    private void readRecords(){
        ...
        try //read records
        {
            ...
            input = new Scanner(new File("clients.txt"));
                while(input.hasNext())//input the value from file
                {
                    record.setAccount(input.nextInt());//record account number
    ...
    private MenuOption getRequest(){
        ...
        System.out.printf("|n%s\n%s\n%s\n%s\n%s\n", "Enter Request", "1-List accounts with zero balances",
                "2-List accounts with credit balances", "3-List accounts with debit balances", "4-End of the run");
    ...
    public void processRequest(){
        //get user's request(e.q., zero, credit, or debit balance)
